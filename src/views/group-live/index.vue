...
export default {
  ...
  computed: {
    ...mapState({
      ...
      groupID: state => state.groupLiveInfo.groupID,
      roomID: state => state.groupLiveInfo.roomID,
      anchorID: state => state.groupLiveInfo.anchorID,
    }),
  },
  mounted() {
