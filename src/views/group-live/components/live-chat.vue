  ...
  methods: {
    ...
    sendMessage() {
      ...
      const message = this.tim.createTextMessage({
        to: this.groupLiveInfo.roomID,
        conversationType: this.TIM.TYPES.CONV_GROUavChatRoomMessageListP,
...
<style scoped>
  ...
  .message-list .msg-item-text {
    width :100%;
    min-height: 60px;
  }
  .message-list .msg-item-text .avatar {
    width :45px;
    height: 45px;
    border-radius: 50%;
  }
  .message-list .msg-item-text .nick {
    position :relative;
    top: -24px;
    left :8px;
    color: #a5b5c1;
  ...
  .message-list .msg-item-text .msg {
    position: relative;
    top :-25px;
    left: 60px;
  ...
  .message-list .msg-item-text .msg .msg-text {
    display: inline-block;
    height: 100%;
  ...
  .message-list .msg-item-text .msg::before {
    position: absolute;
    top: 0;
    width: 12px;
    height: 40px;
  ...
  .message-list .msg-item-gift .avatar {
    width: 45px;
    height :45px;
    border-radius :50%;
    margin :8px;
  }
  .message-list .msg-item-gift .nick {
    position :relative;
    top :-32px;
    left :0px;
    color :#fff;
  ...
  .message-list .msg-item-gift .msg {
    position :relative;
    top :-35px;
    left :-5px;
    padding: 0 0 0 65px;
  ...
  .message-list .msg-item-gift .gift-pic {
    position: absolute;
    top :-15px;
    right :-18px;
    width :75px;
  ...
  .send-container .comment-message {
      flex: 1;
      margin :0;
      border-radius: 0;
      border :hidden;
