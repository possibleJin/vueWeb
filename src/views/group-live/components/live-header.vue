...
<style scoped>
 .header-container {
  ...
  .header-container .anchor-info .anchor-avatar {
    width :50px;
    height: 50px;
    border-radius: 50%;
    margin: 0 5px;
  }
  .header-container .anchor-info .anchor-other {
    height :100%;
    flex :1;
  }

  .header-container .anchor-info .anchor-other p {
    margin: 0;
  }
  .header-container .anchor-info .anchor-other .anchor-nick{
    max-width :140px;
    margin: 6px 0 0 0;
    color: #ffffff;
    font-weight: 500;
  ...
  .header-container .anchor-info .anchor-other .online-num{
    font-size :14px;
    font-weight :400;
    color :#d2cbcbad;
  }
  ...
  .header-container .online-info .room-name{
  ...
  .header-container .online-info .living-icon{
    position: relative;
    top: -3px;
    margin: 0 5px;
    width: 25px;
  }
  .header-container .online-info span {
    margin :2px 0 0 0;
  }

  .header-container .close-box {
    position :absolute;
    right: 0;
    top: 0px;
    width :70px;
