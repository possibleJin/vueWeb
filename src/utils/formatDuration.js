...
// function formatInt2(int) {
//     return int < 10 ? '0'+int : int
// }

// function formatDuration(duration) {
//     if (duration < 60 ) {
//         return `00:00:${formatInt2}`
//     }
//     if (duration < 60 * 60) {
//         const min = parseInt(duration /60)
//         const sec = duration - min/60
//         return `00:${formatInt2(min)}:${formatInt2(sec)}`
//     }
//     const hour = parseInt(duration/(60*60))
//     const min = parseInt((duration - hour/(60*60)/60))
//     const sec = duration - hour*60*60 - min*60
//     return `${formatInt2(hour)}:${formatInt2(min)}:${formatInt2(sec)}`
// }
